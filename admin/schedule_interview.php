...
$applicants = mysqli_fetch_all($result, MYSQLI_ASSOC); // Store results in a variable
                    ...
                    <form id="scheduleForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="interviewer" name="interviewer" class="form-control" required>
                                ...
                                <option value="HR1">Isaiah Guinto</option>
                                <option value="HR2">John Patrick Colanta</option>
                                
                                <!-- Add more HR names as needed -->
                            </select>
                        </div>
