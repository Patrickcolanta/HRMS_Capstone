                                                                        ...
                                                                        <div class="tab-content">
                                                                            <div class="tab-pane active" id="clock_in" role="tabpanel">
                                                                                <div class="auth-box col-xl-12">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <input type="text" class="form-control" placeholder="Staff ID" id="clock_in_id" name="clock_in_id" oninput="this.value = this.value.toUpperCase()" value="<?php echo isset($_SESSION['staff_id']) ? $_SESSION['staff_id'] : ''; ?>">
                                                                            ...
                                                                            <div class="tab-pane" id="clock_out" role="tabpanel">
                                                                                <div class="auth-box col-xl-12">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <input type="text" class="form-control" placeholder="Staff ID" id="clock_out_id" name="clock_out_id" oninput="this.value = this.value.toUpperCase()" value="<?php echo isset($_SESSION['staff_id']) ? $_SESSION['staff_id'] : ''; ?>">
                                                                                        <span class="md-line"></span>
                                                                                    </div>
                                                                                    <div class="row m-t-15">
                                                                                        <div class="col-md-12">
